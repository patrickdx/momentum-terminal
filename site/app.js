...
function selectStock(id) { state.selected=id; renderTable(); if(matchMedia('(max-width:950px)').matches) $('#stock-detail').scrollIntoView({behavior:matchMedia('(prefers-reduced-motion:reduce)').matches?'auto':'smooth',block:'start'}); }
